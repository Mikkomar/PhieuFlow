...
public sealed class KeycloakClientOptions
{
    ...
    /// <summary>
    /// Scopes to request. <c>forms:read</c> is a default client scope in the realm and is
    /// always present; <c>forms:write</c> is optional and must be asked for explicitly.
    /// </summary>
    public string Scope { get; set; } = "forms:write";
